        ...
        <div className="space-y-8">
          ...
          <div className="space-y-1">
            <button
              ...
              className={`w-full p-3 rounded text-xs font-bold flex items-center gap-2.5 transition text-left ${activeTab === 'leave' ? 'bg-brand-500/10 border-l-4 border-brand-500 text-brand-700 dark:text-brand-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900'}`}
            >
              <Calendar size={16} />
            ...
            <button
              ...
              className={`w-full p-3 rounded text-xs font-bold flex items-center gap-2.5 transition text-left ${activeTab === 'complaint' ? 'bg-brand-500/10 border-l-4 border-brand-500 text-brand-700 dark:text-brand-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900'}`}
            >
            ...
            <button
              ...
              className={`w-full p-3 rounded text-xs font-bold flex items-center gap-2.5 transition text-left ${activeTab === 'my_requests' ? 'bg-brand-500/10 border-l-4 border-brand-500 text-brand-700 dark:text-brand-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900'}`}
            >
              <FileText size={16} />
            ...
            <button
              ...
              className={`w-full p-3 rounded text-xs font-bold flex items-center gap-2.5 transition text-left ${activeTab === 'host_visits' ? 'bg-brand-500/10 border-l-4 border-brand-500 text-brand-700 dark:text-brand-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900'}`}
            >
              <User size={16} />
      ...
      <main className="flex-1 p-8 space-y-8 overflow-y-auto">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm mt-1 font-light">Submit holiday requests, raise complaints, view AI risk levels, and track status resolution.</p>
          </div>
        </div>
